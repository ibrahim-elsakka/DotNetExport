...
using Metadata = DotNetExport.dnlib.DotNet.MD.Metadata;
using MethodBody = DotNetExport.dnlib.DotNet.Emit.MethodBody;

namespace DotNetExport.dnlib.DotNet {
	/// <summary>
	...
	public sealed class ModuleDefMD : ModuleDefMD2, IInstructionOperandResolver {
		...
		public void NativeWrite(string filename, NativeModuleWriterOptions options) {
			var writer = new NativeModuleWriter(this, options ?? new NativeModuleWriterOptions(this, optimizeImageSize: true));
