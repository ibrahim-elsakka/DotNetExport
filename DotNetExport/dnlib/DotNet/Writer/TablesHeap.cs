...
#pragma warning restore
		...
		public void WriteTo(DataWriter dataWriter) {
			dataWriter.WriteUInt32(options.Reserved1 ?? 0);
			dataWriter.WriteByte(majorVersion);
			dataWriter.WriteByte(minorVersion);
			dataWriter.WriteByte((byte)GetMDStreamFlags());
			dataWriter.WriteByte(GetLog2Rid());
			dataWriter.WriteUInt64(GetValidMask());
			dataWriter.WriteUInt64(GetSortedMask());
			foreach (var mdt in Tables) {
				if (!mdt.IsEmpty)
					dataWriter.WriteInt32(mdt.Rows);
			}
			if (options.ExtraData.HasValue)
				dataWriter.WriteUInt32(options.ExtraData.Value);

			dataWriter.Write(metadata, ModuleTable);
			dataWriter.Write(metadata, TypeRefTable);
			dataWriter.Write(metadata, TypeDefTable);
			dataWriter.Write(metadata, FieldPtrTable);
			dataWriter.Write(metadata, FieldTable);
			dataWriter.Write(metadata, MethodPtrTable);
			dataWriter.Write(metadata, MethodTable);
			dataWriter.Write(metadata, ParamPtrTable);
			dataWriter.Write(metadata, ParamTable);
			dataWriter.Write(metadata, InterfaceImplTable);
			dataWriter.Write(metadata, MemberRefTable);
			dataWriter.Write(metadata, ConstantTable);
			dataWriter.Write(metadata, CustomAttributeTable);
			dataWriter.Write(metadata, FieldMarshalTable);
			dataWriter.Write(metadata, DeclSecurityTable);
			dataWriter.Write(metadata, ClassLayoutTable);
			dataWriter.Write(metadata, FieldLayoutTable);
			dataWriter.Write(metadata, StandAloneSigTable);
			dataWriter.Write(metadata, EventMapTable);
			dataWriter.Write(metadata, EventPtrTable);
			dataWriter.Write(metadata, EventTable);
			dataWriter.Write(metadata, PropertyMapTable);
			dataWriter.Write(metadata, PropertyPtrTable);
			dataWriter.Write(metadata, PropertyTable);
			dataWriter.Write(metadata, MethodSemanticsTable);
			dataWriter.Write(metadata, MethodImplTable);
			dataWriter.Write(metadata, ModuleRefTable);
			dataWriter.Write(metadata, TypeSpecTable);
			dataWriter.Write(metadata, ImplMapTable);
			dataWriter.Write(metadata, FieldRVATable);
			dataWriter.Write(metadata, ENCLogTable);
			dataWriter.Write(metadata, ENCMapTable);
			dataWriter.Write(metadata, AssemblyTable);
			dataWriter.Write(metadata, AssemblyProcessorTable);
			dataWriter.Write(metadata, AssemblyOSTable);
			dataWriter.Write(metadata, AssemblyRefTable);
			dataWriter.Write(metadata, AssemblyRefProcessorTable);
			dataWriter.Write(metadata, AssemblyRefOSTable);
			dataWriter.Write(metadata, FileTable);
			dataWriter.Write(metadata, ExportedTypeTable);
			dataWriter.Write(metadata, ManifestResourceTable);
			dataWriter.Write(metadata, NestedClassTable);
			dataWriter.Write(metadata, GenericParamTable);
			dataWriter.Write(metadata, MethodSpecTable);
			dataWriter.Write(metadata, GenericParamConstraintTable);
			dataWriter.Write(metadata, DocumentTable);
			dataWriter.Write(metadata, MethodDebugInformationTable);
			dataWriter.Write(metadata, LocalScopeTable);
			dataWriter.Write(metadata, LocalVariableTable);
			dataWriter.Write(metadata, LocalConstantTable);
			dataWriter.Write(metadata, ImportScopeTable);
			dataWriter.Write(metadata, StateMachineMethodTable);
			dataWriter.Write(metadata, CustomDebugInformationTable);
			dataWriter.WriteZeroes((int)(Utils.AlignUp(length, HeapBase.ALIGNMENT) - length));
		}
