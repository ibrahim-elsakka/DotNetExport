...
namespace DotNetExport.dnlib.DotNet.Writer {
	...
	public sealed class ModuleWriter : ModuleWriterBase {
        ...
        internal ManagedExportsWriter ExportsWriter => managedExportsWriter;
        ...
        public NativeEntryPoint NativeEntryPoint => nativeEp;
		...
		void CreateChunks() {
			...
			nativeEp = new NativeEntryPoint(this, is64bit);
		...
		void AddChunksToSections() {
            ...
            textSection.Add(ImportDirectory.ImportAddress, pointerAlignment);
			...
			textSection.Add(nativeEp, 16);
			textSection.Add(methodBodies, 16);
            ...
            textSection.Add(importDirectory, 16);
			textSection.Add(startupStub, 16);
