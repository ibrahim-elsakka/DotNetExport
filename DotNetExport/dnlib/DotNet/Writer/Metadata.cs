...
using DotNetExport.dnlib.DotNet.Pdb.Portable;
...
namespace DotNetExport.dnlib.DotNet.Writer {
	...
	public readonly struct MetadataHeapsAddedEventArgs {
		...
		/// Constructor
		/// </summary>
		/// <param name="metadata">Metadata dataWriter</param>
	...
	/// <summary>
	/// Metadata dataWriter event args
	/// </summary>
	...
	/// <summary>
	/// Metadata dataWriter progress event args
	/// </summary>
	...
	public abstract class Metadata : IReuseChunk, ISignatureWriterHelper, ITokenProvider, ICustomAttributeWriterHelper, IPortablePdbCustomDebugInfoWriterHelper {
		...
		public void WriteTo(DataWriter dataWriter) {
			var rva2 = rva;
			metadataHeader.VerifyWriteTo(dataWriter);
			rva2 += metadataHeader.GetFileLength();

			foreach (var heap in metadataHeader.Heaps) {
				dataWriter.WriteZeroes((int)(rva2.AlignUp(HEAP_ALIGNMENT) - rva2));
				rva2 = rva2.AlignUp(HEAP_ALIGNMENT);
				heap.VerifyWriteTo(dataWriter);
